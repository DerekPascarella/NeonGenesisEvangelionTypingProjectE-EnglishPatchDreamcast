...
|
|   1) Display the English alphabet letters that correspond to each Katakana,
...
|      English letters into the space provided on-screen for each character.
...
|        a. Display as many English letters as I’d like for each Katakana,
...
| to be typed.  As it is much simpler to fit the two or three English letters
